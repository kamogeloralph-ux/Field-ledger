...
// Loads the same logo file used elsewhere in the app (client/public/rovaya-wordmark-logo.png) so the
...
function loadLogoImage(): Promise<HTMLImageElement | null> {
  return new Promise((resolve) => {
    ...
    img.src = `${import.meta.env.BASE_URL}rovaya-wordmark-logo.png`;
  });
}
